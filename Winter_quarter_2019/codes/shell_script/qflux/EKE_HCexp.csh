...
for i in {0..9};
do       
python $fall18/codes/python_scripts/qflux/Calculate_EKE_depths.py $1 $2 $3 $i
done;        
python $fall18/codes/python_scripts/qflux/Reload_EKE_save_interpolated_depths.py $1 $2 $3 10

...
for i in {0..9};
do       
python $win19/codes/python_scripts/am2/Extract_ncfile_save_fluxes_radiation_depths.py $1 $2 $3 $i
done;        

python $win19/codes/python_scripts/am2/Reload_save_interpolated_depths.py $1 $2 $3 10
python $win19/codes/python_scripts/am2/Reload_save_thermo_dynamic_mmc.py $1 $2 $3 10

...
log_directory='/project2/tas1/pragallva/Winter_quarter_2019/codes/shell_script/log/'+'baroclinic'+name
...
for i in range(0,int(num)):
 source='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/data_in_pres_coord/'+name+str(i)+'/'
...
destination='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/data_in_pres_coord/'+name+'/'

...
log_directory='/project2/tas1/pragallva/Winter_quarter_2019/codes/shell_script/greyT85/log/'+filename+'_MMC_decomp'
...
destination='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/greyT85/'+filename+'/'
...
del_mv_mmc_vert=[]
del_mv_mmc_sensible_vert=[]
del_mv_mmc_pot_vert=[]
del_mv_mmc_moist_vert=[]
...
for i in range(0,int(num)):
 source='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/greyT85/'+filename+str(i)+'/'
 ...
 del_mv_mmc.append(non_vertical_fluxes[i]['del_mv_mmc'])
 del_mv_mmc_moist.append(non_vertical_fluxes[i]['del_mv_mmc_moist'])
 del_mv_mmc_sensible.append(non_vertical_fluxes[i]['del_mv_mmc_sensible'])
 del_mv_mmc_pot.append(non_vertical_fluxes[i]['del_mv_mmc_pot'])
  
 del_mv_mmc_vert.append(vertical_fluxes[i]['del_mv_mmc'])
 del_mv_mmc_moist_vert.append(vertical_fluxes[i]['del_mv_mmc_moist'])
 del_mv_mmc_sensible_vert.append(vertical_fluxes[i]['del_mv_mmc_sensible'])
 del_mv_mmc_pot_vert.append(vertical_fluxes[i]['del_mv_mmc_pot'])
...
source1      ="/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/greyT85/"+filename+'/'
...
del_mv_mmc=M(del_mv_mmc); 
del_mv_mmc_sensible=M(del_mv_mmc_sensible); 
del_mv_mmc_pot=M(del_mv_mmc_pot); 
del_mv_mmc_moist=M(del_mv_mmc_moist); 

del_mv_mmc_vert=M(del_mv_mmc_vert); 
del_mv_mmc_sensible_vert=M(del_mv_mmc_sensible_vert); 
del_mv_mmc_pot_vert=M(del_mv_mmc_pot_vert); 
del_mv_mmc_moist_vert=M(del_mv_mmc_moist_vert); 
...
del_mv_mmc_interp=np.zeros((LATN,MONTHS))
...
def integrated(x):
    ...
    #  (This is basically integration from - 90 deg)
...
del_mv_mmc=interpolate_non_vertical(del_mv_mmc); 
del_mv_mmc_sensible=interpolate_non_vertical(del_mv_mmc_sensible);
del_mv_mmc_pot=interpolate_non_vertical(del_mv_mmc_pot);
del_mv_mmc_moist=interpolate_non_vertical(del_mv_mmc_moist); 

del_mv_mmc_vert=interpolate_vertical(del_mv_mmc_vert); 
del_mv_mmc_sensible_vert=interpolate_vertical(del_mv_mmc_sensible_vert);
del_mv_mmc_pot_vert=interpolate_vertical(del_mv_mmc_pot_vert);
del_mv_mmc_moist_vert=interpolate_vertical(del_mv_mmc_moist_vert);
...
mmc_decompose_interp = {'MM_flux':zon_int(MM_flux),'del_m_mmc':zon_int(del_m_mmc),'del_v_mmc':zon_int(del_v_mmc),'del_m_mmc_moist':zon_int(del_m_mmc_moist),'del_m_mmc_sensible':zon_int(del_m_mmc_sensible),'del_m_mmc_pot':zon_int(del_m_mmc_pot),'del_v_mmc_moist':zon_int(del_v_mmc_moist),'del_v_mmc_sensible':zon_int(del_v_mmc_sensible),'del_v_mmc_pot':zon_int(del_v_mmc_pot), 'del_mv_mmc':zon_int(del_mv_mmc),'del_mv_mmc_moist':zon_int(del_mv_mmc_moist),'del_mv_mmc_sensible':zon_int(del_mv_mmc_sensible),'del_mv_mmc_pot':zon_int(del_mv_mmc_pot),'latn':latn } #'KE':zon_int(KE_interp) 


save(destination+'mmc_decompose_interp.hkl', mmc_decompose_interp)
logging.debug("Saved decompose mmc dictionary")

mmc_decompose_vert_interp = {'MM_flux':zon_int_vert(MM_flux_vert),'del_m_mmc':zon_int_vert(del_m_mmc_vert),'del_v_mmc':zon_int_vert(del_v_mmc_vert),'del_m_mmc_moist':zon_int_vert(del_m_mmc_moist_vert),'del_m_mmc_sensible':zon_int_vert(del_m_mmc_sensible_vert),'del_m_mmc_pot':zon_int_vert(del_m_mmc_pot_vert),'del_v_mmc_moist':zon_int_vert(del_v_mmc_moist_vert),'del_v_mmc_sensible':zon_int_vert(del_v_mmc_sensible_vert),'del_v_mmc_pot':zon_int_vert(del_v_mmc_pot_vert),'del_mv_mmc':zon_int_vert(del_mv_mmc_vert),'del_mv_mmc_moist':zon_int_vert(del_mv_mmc_moist_vert),'del_mv_mmc_sensible':zon_int_vert(del_mv_mmc_sensible_vert),'del_mv_mmc_pot':zon_int_vert(del_mv_mmc_pot_vert),'latn':latn } #'KE':zon_int(KE_interp) 

...
source1='/project2/tas1/pragallva/Winter_quarter_2019/exp_data/grey/'+filename+'/'
one_year=filename+'0.nc'
...
for i in range(0,int(num)):
 source='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/greyT85/data_in_pres_coord/'+filename+str(i)+'/'
...
destination='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/greyT85/data_in_pres_coord/'+filename+'/'

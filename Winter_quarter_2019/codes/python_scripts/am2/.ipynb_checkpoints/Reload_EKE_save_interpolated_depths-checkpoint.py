...
destination='/project2/tas1/pragallva/Fall_quarter_2018/post_process_data/am2/'+'HC'+edge+'_la'+land+'m_oc'+ocean+'m/'
...
for i in range(0,int(num)):
 source='/project2/tas1/pragallva/Fall_quarter_2018/post_process_data/am2/'+'HC'+edge+'_la'+land+'m_oc'+ocean+'m'+str(i)+'/'
...
coord_source = '/project2/tas1/pragallva/Fall_quarter_2018/post_process_data/am2/HC0_la16m_oc16m0/' 
...
raw_data_dict={'EKE':EKE_interp,'EKE_vert':EKE_vert_interp, 'EMF':EMF_interp,'EMF_vert':EMF_vert_interp, 'latn':latn,'sigma_full':raw_data[0]['sigma_full'],'latn':latn}

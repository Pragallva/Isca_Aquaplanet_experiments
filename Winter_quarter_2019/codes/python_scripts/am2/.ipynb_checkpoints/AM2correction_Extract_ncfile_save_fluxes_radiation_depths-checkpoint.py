...
log_directory='/project2/tas1/pragallva/Fall_quarter_2018/codes/shell_script/am2/log/'+'correct_HC'+edge+'_la'+land+'m_oc'+ocean+'m'
...
lat_file='/project2/tas1/pragallva/Fall_quarter_2018/exp_data/am2/HC0_la16m_oc16m/HC0_la16m_oc16m0.nc'
lat=nc.Dataset(lat_file,'r').variables['lat'][:]

logging.debug('...........Shape correction.py.............'+str(num))
...
temp    = regrid4(temp)
logging.debug("regrid temp:"+str(np.shape(temp)))
u_comp  = regrid4(u_comp)
logging.debug("regrid u:"+str(np.shape(u_comp)))
v_comp  = regrid4(v_comp)
logging.debug("regrid v:"+str(np.shape(v_comp)))
Z       = regrid4(Z)
logging.debug("regrid Z:"+str(np.shape(Z)))
q       = regrid4(q)
logging.debug("regrid q:"+str(np.shape(q)))
p_sfc   = regrid3(p_sfc)
logging.debug("regrid psfc:"+str(np.shape(p_sfc)))
...
shflx   = regrid3(v_var['shflx'][...]) ### Surface sensible heat flux
lhflx   = regrid3(L*v_var['evap'][...])             ### Latent heat of fusion
LW_d_sfc= regrid3(v_var['lwdn_sfc'][...])
LW_u_sfc= regrid3(v_var['lwup_sfc'][...])
SW_d_sfc= regrid3(v_var['swdn_sfc'][...])
SW_u_sfc= regrid3(v_var['swup_sfc'][...])

##### TOA

LW_u_toa=regrid3(v_var['olr'][...])
SW_d_toa=regrid3(v_var['swdn_toa'][...])
SW_u_toa=regrid3(v_var['swup_toa'][...])
#netrad_toa=v_var['netrad_toa'][...]
...
coord_dic       ={"lat":lat,"lon":lon,"p_sfc":p_sfc,"no_of_plevels":len(sigma_full),"plev": plev} 

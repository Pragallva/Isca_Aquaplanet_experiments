...
log_directory='/project2/tas1/pragallva/Winter_quarter_2019/codes/shell_script/am2/log/'+filename+'_MMC_decomp'
...
destination='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/am2/'+filename+'/'
...
for i in range(0,int(num)):
 source='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/am2/'+filename+str(i)+'/'
...
source1='/project2/tas1/pragallva/Fall_quarter_2018/post_process_data/am2/HC0_la5m_oc5m0/'

...
u = data.variables['ucomp'][:].transpose(2,1,0,3)* units.meter / (units.second)
logging.debug(str(num)+'imported u')
ht = data.variables['zfull'][:].transpose(2,1,0,3)* units.meter 
logging.debug(str(num)+'imported ht')
temp = data.variables['temp'][:].transpose(2,1,0,3) * units.K

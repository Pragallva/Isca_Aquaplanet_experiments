...
log_directory='/project2/tas1/pragallva/Winter_quarter_2019/codes/shell_script/grey/log/'+filename+'_MMC_decomp'
...
destination='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/grey/'+filename+'/'
...
for i in range(0,int(num)):
 source='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/grey/'+filename+str(i)+'/'
...
source1      ="/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/grey/"+filename+'0/'

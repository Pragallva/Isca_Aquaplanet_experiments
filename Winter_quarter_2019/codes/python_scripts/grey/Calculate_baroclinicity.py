...
log_directory='/project2/tas1/pragallva/Winter_quarter_2019/codes/shell_script/grey/log/'+'baroclinic'+filename
...
for i in range(0,int(num)):
 source='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/grey/data_in_pres_coord/'+filename+str(i)+'/'
...
destination='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/grey/data_in_pres_coord/'+filename+'/'

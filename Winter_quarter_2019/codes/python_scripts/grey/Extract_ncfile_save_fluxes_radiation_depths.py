...
log_directory='/project2/tas1/pragallva/Winter_quarter_2019/codes/shell_script/grey/log/'+filename
...
destination='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/grey/'+filename+num+'/'
...
temp      =shift(v_var['temp'][:,::-1,:,:]) ## (time, lev, lat, lon)
...
q         =shift(v_var['sphum'][:,::-1,:,:])  ### Specific humidity
logging.debug('saved q')
EKE       =shift(v_var['EKE'][...])  ### Specific humidity
...
albedo=0.38
SW_sfc_dn=shift(v_var['swdn_sfc'][...])/(1-albedo)  # Absorbed SW at surface, in W/m^2
SW_sfc_up=shift(v_var['swdn_sfc'][...])*albedo/(1-albedo)  # Absorbed SW at surface, in W/m^2

LW_sfc_dn=shift(v_var['lwdn_sfc'][...])  # LW flux down at surface, in W/m^2
LW_sfc_up=shift(v_var['lwup_sfc'][...])  # LW flux up at surface, in W/m^2
olr      =shift(v_var['olr'][...])       # Outgoing LW radiation
SW_toa_dn=shift(v_var['swdn_toa'][...])  # SW flux down at TOA, in W/m^2

flux_rad=shift(v_var['flux_rad'][...]) 
flux_lw =shift(v_var['flux_lw'][...])    # Net longwave radiative flux (positive up), in W/m^2
flux_sw =shift(v_var['flux_sw'][...])  # Net shortwave radiative flux (positive up), in W/m^2
...
shflx=shift(v_var['flux_t'][...])   ### Surface sensible heat flux
lhflx=shift(v_var['flux_lhe'][...]) #### Latent heat of fu sion 

flux_oceanq = shift(v_var['flux_oceanq'][...])  ### Specific humidity
logging.debug('saved flux_oceanq')

precip    = shift(v_var['precipitation'][...])

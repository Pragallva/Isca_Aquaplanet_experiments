...
source='/project2/tas1/pragallva/Fall_quarter_2018/exp_data/reverse/HC'+edge+'_la'+land+'m_oc'+ocean+'m/'
one_year=source+'HC'+edge+'_la'+land+'m_oc'+ocean+'m'+num+'.nc'

destination='/project2/tas1/pragallva/Fall_quarter_2018/post_process_data/reverse/data_in_pres_coord/'+'HC'+edge+'_la'+land+'m_oc'+ocean+'m'+num+'/'

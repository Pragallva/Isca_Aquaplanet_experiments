...
experiment_name = "sst1_"+str(frac)+"x_solar"
baseexp = Experiment(experiment_name, overwrite_data=False)

baseexp.inputfiles = ['/project/tas1/pragallva/Fall_quarter_2017/Isca/input/ozone_1990.nc', '/project/tas1/pragallva/Fall_quarter_2017/Isca/input/sst_field.nc'] 
...
baseexp.namelist['mixed_layer_nml']['sst_file']='sst_field'
baseexp.namelist['mixed_layer_nml']['sst_field_name']='zon_symmetric_sst'
...
baseexp.namelist['rrtm_radiation_nml']['solr_cnst'] = 1368.22*float(frac)

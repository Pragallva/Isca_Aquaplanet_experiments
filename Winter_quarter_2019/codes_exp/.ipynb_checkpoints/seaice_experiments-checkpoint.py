...
experiment_name = '50m_seaice_'+str(dirc[1])
land_name       = 'symmetric_antarctica'
baseexp         = Experiment(experiment_name, overwrite_data=False)

baseexp.inputfiles = ['/project/tas1/pragallva/Fall_quarter_2017/Isca/input/ozone_1990.nc','/project2/tas1/pragallva/Summer_quarter_2018/land_files/symmetric_antarctica.nc']

...
#source='/project2/tas1/pragallvaring_quarter_2018/post_process_data/qflux/'+dirc[1]+'_'+dirc[2]+str(i)+'/'

destination='/project2/tas1/pragallva/Fall_quarter_2018/post_process_data/qflux/'+'HC'+edge+'_la'+land+'m_oc'+ocean+'m/'
...
for i in range(0,int(num)):
 source='/project2/tas1/pragallva/Fall_quarter_2018/post_process_data/qflux/'+'HC'+edge+'_la'+land+'m_oc'+ocean+'m'+str(i)+'/'
...
# import shutil
# for i in range(0,int(num)):
#  source='/project2/tas1/pragallva/Spring_quarter_2018/post_process_data/qflux/'+dirc[1]+'_'+dirc[2]+str(i)+'/'

...
source='/project2/tas1/pragallva/Fall_quarter_2018/exp_data/am2/'+filename+'/'
one_year=source+filename+num+'.nc'

destination='/project2/tas1/pragallva/Winter_quarter_2019/post_process_data/am2/'+filename+num+'/'

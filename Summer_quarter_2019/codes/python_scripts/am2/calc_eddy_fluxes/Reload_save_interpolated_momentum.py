...
destination = quarter+'/post_process_data/am2_repeat/data_in_pres_coord/avged_over'+str(no_of_days)+'days/'+exp_dir+'/'
make_sure_path_exists(destination);


for i in range(0,int(num)):
  source=quarter+'/post_process_data/am2_repeat/data_in_pres_coord/avged_over'+str(no_of_days)+'days/'+exp_dir+str(i)+'/'

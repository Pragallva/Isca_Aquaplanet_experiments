...
experiment_name='zonal_tracmipqflux'
land_name      ='Ruth_full1'
baseexp = Experiment(experiment_name, overwrite_data=False)

baseexp.inputfiles = ['/project2/tas1/pragallva/Fall_quarter_2017/land_files/'+land_name+'.nc', 
                      '/project/tas1/pragallva/Fall_quarter_2017/Isca/input/ozone_1990.nc',
                      '/project/tas1/pragallva/Fall_quarter_2017/Isca/input/ocean_qflux.nc'] 
...
#baseexp.namelist['idealized_moist_phys_nml']['do_rrtm'] = False
...
baseexp.namelist['mixed_layer_nml']['land_option_zonal']    = True
...
baseexp.screen_runmonth_prefix = 'tracmip_qflux'

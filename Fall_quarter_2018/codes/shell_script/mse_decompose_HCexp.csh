...
for i in {0..9};
do       
python $fall18/codes/python_scripts/Extract_ncfile_save_fluxes_radiation_depths.py $1 $2 $3 $i
done;        

python $fall18/codes/python_scripts/Reload_save_interpolated_depths.py $1 $2 $3 10
python $fall18/codes/python_scripts/Reload_save_thermo_dynamic_mmc.py $1 $2 $3 10

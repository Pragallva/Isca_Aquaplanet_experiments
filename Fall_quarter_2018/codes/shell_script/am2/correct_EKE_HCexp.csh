...
for i in {0..9};
do       
python $fall18/codes/python_scripts/am2/AM2correction_Calculate_EKE_depths.py $1 $2 $3 $i
done;        
python $fall18/codes/python_scripts/am2/Reload_EKE_save_interpolated_depths.py $1 $2 $3 10

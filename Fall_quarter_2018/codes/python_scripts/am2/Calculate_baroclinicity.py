...
source1='/project2/tas1/pragallva/Fall_quarter_2018/exp_data/am2/HC0_la16m_oc16m/'
one_year="HC0_la16m_oc16m0.nc"
...
for i in range(0,int(num)):
 source='/project2/tas1/pragallva/Fall_quarter_2018/post_process_data/am2/data_in_pres_coord/'+'HC'+edge+'_la'+land+'m_oc'+ocean+'m'+str(i)+'/'
...
destination='/project2/tas1/pragallva/Fall_quarter_2018/post_process_data/am2/data_in_pres_coord/'+'HC'+edge+'_la'+land+'m_oc'+ocean+'m/'

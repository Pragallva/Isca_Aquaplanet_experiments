...
log_directory='/project2/tas1/pragallva/Fall_quarter_2018/codes/shell_script/reverse/log/'+'baroclinic'+edge+'_la'+land+'m_oc'+ocean+'m'
...
for i in range(0,int(num)):
 source='/project2/tas1/pragallva/Fall_quarter_2018/post_process_data/reverse/data_in_pres_coord/'+'HC'+edge+'_la'+land+'m_oc'+ocean+'m'+str(i)+'/'
...
destination='/project2/tas1/pragallva/Fall_quarter_2018/post_process_data/reverse/data_in_pres_coord/'+'HC'+edge+'_la'+land+'m_oc'+ocean+'m/'

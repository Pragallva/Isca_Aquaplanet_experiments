...
log_directory='/project2/tas1/pragallva/Fall_quarter_2018/codes/shell_script/reverse/log/'+'EKE'+edge+'_la'+land+'m_oc'+ocean+'m'
...
#source='/project2/tas1/pragallvaring_quarter_2018/post_process_data/reverse/'+dirc[1]+'_'+dirc[2]+str(i)+'/'

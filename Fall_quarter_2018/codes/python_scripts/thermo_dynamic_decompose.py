...
log_directory='/project2/tas1/pragallva/Fall_quarter_2018/codes/shell_script/log/'+'HC'+edge+'_la'+land+'m_oc'+ocean+'m_MMC_decomp'
...
MMC_thermo_dynamic_dic   ={"MM_flux":MM_flux, "del_m_mmc":del_m_mmc, "del_v_mmc":del_v_mmc} #, "del_m_mmc_sensible":del_m_mmc_sensible, "del_v_mmc_sensible":del_v_mmc_sensible, "del_v_mmc_moist":del_v_mmc_moist, "del_m_mmc_moist":del_m_mmc_moist,"del_v_mmc_pot":del_v_mmc_pot,"del_m_mmc_pot":del_m_mmc_pot}

save(destination+"MMC_thermo_dynamic_dic.hkl" ,MMC_thermo_dynamic_dic)
logging.debug("loaded MMC_thermo_dynamic dictionary")


#MMC_thermo_dynamic_dic_vert   ={"MM_flux":MM_flux_vert,"MM_sensible":MM_sensible_vert,"MM_moist":MM_moist_vert,"MM_pot":MM_pot_vert, "del_m_mmc":del_m_mmc_vert, "del_v_mmc":del_v_mmc_vert, "del_m_mmc_sensible_vert":del_m_mmc_sensible_vert, "del_v_mmc_sensible_vert":del_v_mmc_sensible_vert, "del_v_mmc_moist_vert":del_v_mmc_moist_vert, "del_m_mmc_moist_vert":del_m_mmc_moist_vert,"del_v_mmc_pot_vert":del_v_mmc_pot_vert,"del_m_mmc_pot_vert":del_m_mmc_pot_vert}

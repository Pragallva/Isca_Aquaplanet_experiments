...
experiment_name=str(dirc[1])+'m_aqua_0qflux_0ecc_2xSun'
...
baseexp.namelist['mixed_layer_nml']['albedo_value'] = 0.3 # 0.65
...
## Double the sun
baseexp.namelist['rrtm_radiation_nml']['solr_cnst']=1368.22*1.05

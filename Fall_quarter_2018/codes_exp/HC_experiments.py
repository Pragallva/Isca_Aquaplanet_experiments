...
diag_spinup.add_field('atmosphere', 'convection_rain', time_avg=True, files=['atmos_4xdaily'])
diag_spinup.add_field('atmosphere', 'condensation_rain', time_avg=True, files=['atmos_4xdaily'])

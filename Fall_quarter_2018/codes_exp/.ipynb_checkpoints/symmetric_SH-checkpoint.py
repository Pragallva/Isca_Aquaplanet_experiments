...
experiment_name=str(dirc[1])+'m_seaice_0qflux_0ecc'
land_name = 'symmetric_antarctica'
baseexp = Experiment(experiment_name, overwrite_data=False)

baseexp.inputfiles = ['/project/tas1/pragallva/Fall_quarter_2017/Isca/input/ozone_1990.nc','/project2/tas1/pragallva/Summer_quarter_2018/land_files/symmetric_antarctica.nc','/project2/tas1/pragallva/Summer_quarter_2018/seaice_files/symmetric_seaice.nc'] 
...
baseexp.namelist['mixed_layer_nml']['ice_file_name'] = 'symmetric_seaice'
baseexp.namelist['mixed_layer_nml']['ice_field_name'] = 'sea_ice'
